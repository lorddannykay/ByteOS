/**
 * ByteOS Studio — Learning Personas (Style Engine).
 * Design DNA derived from promptbank, adapted for sustained reading in courses.
 * Used by persona picker and stored in courses.template.
 */
...
export const LEARNING_PERSONAS: Record<LearningPersonaSlug, LearningPersona> = {
  precision: {
    slug: 'precision',
    label: 'Precision',
    description: 'Minimalist monochrome, hairline borders, technical clarity. Ideal for engineering and systems.',
  ...
  editorial: {
    slug: 'editorial',
    label: 'Editorial',
    description: 'Bold headlines, yellow accent, high-energy. Best for marketing and sales.',
    bestFor: ['Marketing', 'Entrepreneurship', 'Sales'],
    preferredColorScheme: 'dark',
    fontDisplay: '"Anton", system-ui, sans-serif',
    fontBody: '"Satoshi", "Inter", system-ui, sans-serif',
  ...
  authority: {
    slug: 'authority',
    label: 'Authority',
    description: 'Serif display, deep red accent, classic proportions. For finance and leadership.',
  ...
  devcore: {
    slug: 'devcore',
    label: 'DevCore',
    description: 'Monospace-first, cyan accent, dark terminal feel. For developer and API courses.',
  ...
  verdant: {
    slug: 'verdant',
    label: 'Verdant',
    description: 'Green and gold, organic spacing, soft radius. For design and wellness.',
