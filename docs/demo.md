...
1. Record a 1–2 minute screen recording (e.g. Loom, OBS, or built-in OS recorder).
2. Upload to a public URL (e.g. YouTube unlisted, Vimeo, or GitHub release asset).
3. Replace the placeholder below with the actual link.
